...
public:
    ...
    /*objeto(const objeto&& temporal) //constructor movimiento
    {
        _id = temporal._id;
        _inicio = temporal._inicio;
        _fin = temporal._fin;
        _centro = temporal._inicio;
        _ancho = temporal._ancho;
        _b_seleccionado = temporal._b_seleccionado;
        _b_highlighteado = temporal._b_highlighteado;
        _color = temporal._color;
        _relaciones = temporal._relaciones; //esto mueve?
    }*/
